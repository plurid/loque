...
import { program, programFromIR } from './program';
import { capability } from './capability';
import { programSchema, querySchema } from './schema';
...
export { program, programFromIR, capability, programSchema, querySchema };
...
export type {
    ...
    Program, ProgramIR, ProgramOptions, ProgramLimits, ProgramResult, ProgramReport, ReportedDecision, RunOptions,
    Capability, CapabilityOptions, MutationKind, Violation,
} from './types';
...
export default Object.freeze({
    ...
    program, programFromIR, capability, programSchema, querySchema,
});
